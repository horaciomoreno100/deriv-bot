"""
Reversal Hunter Strategy - BALANCED VERSION
Python implementation with optimal balance between frequency and win rate
"""
...
class ReversalHunterBalancedStrategy(BaseBinaryStrategy):
    """
    BALANCED Reversal Hunter Strategy
    - Optimized for 5-10 trades/day
    - Target win rate: 55%+
    - Functional Anti-Martingale system
    - All patterns implemented: Pin Bar, Engulfing, Double Red/Green
    """
    ...
    def __init__(self):
        ...
        print(f"🎯 BALANCED Reversal Hunter Strategy initialized")
        print(f"   Min Confidence: {self.params.min_confidence}")
        print(f"   Proximity Threshold: {self.params.proximity_threshold}")
        print(f"   ATR Multiplier: {self.params.atr_multiplier} (LOW for more trades)")
