#!/usr/bin/env python3
"""
Quick test of the OPTIMIZED Reversal Hunter Strategy
"""
...
def main():
    print("🎯 QUICK TEST - OPTIMIZED REVERSAL HUNTER")
    print("="*60)
    print("🔧 OPTIMIZATIONS APPLIED:")
    print("   - Cooldown: 300s → 600s (10 min)")
    ...
    results_file = f"optimized_test_{timestamp}.json"
